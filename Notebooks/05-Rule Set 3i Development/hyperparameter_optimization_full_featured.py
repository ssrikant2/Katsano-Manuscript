...
X = train_df.drop(columns=['sgRNA_Context_Sequence', 'doubleZscore', 'Target_Gene_Symbol']).copy()
...
def main():
    ...
    with open(f'{modelTrainingPath}best_hyperparams_full_featured.csv', 'w') as f:
